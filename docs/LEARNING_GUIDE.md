...
5. 이 프로젝트의 결론("온건한 여름")이 왜 8월과 7월에서 다르게 나타나는지 설명할 수 있나요? *(`REPORT.md` 3.3절, 7장 인사이트 3)*

다섯 문제 모두 막힘없이 답할 수 있다면, 이 미션의 「과제 목표」 3가지를 충분히 달성한 것입니다.
